  ...
  return (
    <div className="max-w-40 flex cursor-pointer flex-col overflow-hidden font-poppins">
      <div className="relative flex h-80 w-full justify-end overflow-hidden p-4">
        <div>💓</div>
        <div className="absolute left-0 top-0 h-full w-full rounded-lg bg-gray-500 object-cover transition-all" />
      </div>
      <div className="flex flex-col gap-1.5 py-4">
        <div className="flex justify-between">
          <h3 className="text-lg font-bold">Title goes here</h3>
          <div>4.5</div>
        </div>
        ...
        <div className="text-sm">
          From <span className="text-lg font-bold">1200</span>
        </div>
      </div>
    </div>
  );
