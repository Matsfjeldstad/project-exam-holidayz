export default function Navbar() {
  ...
  const hoverLinkClass =
    "after:duration-150 after:absolute after:bottom-0 after:right-0 after:h-1 after:w-0 after:bg-gray-900 after:opacity-0  hover:after:opacity-100 hover:after:w-full";
